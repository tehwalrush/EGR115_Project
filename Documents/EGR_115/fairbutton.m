...
fair_mat_select.Position(4) = 0.36;
fair_thickness.Position(4) = 0.03*ScreenHeight;
fair_weight.Position(4) = 0.03*ScreenHeight;
fair_price_overall.Position(4) = 0.03*ScreenHeight;
...
if strcmp(fair_price_overall.String, "Fairing Cost: ") == 0
...
% DISPLAY ONLY UICONTROLS THAT ARE ON FAIRING SECTION
