...
for pos = 1:length(engine)
    engine(pos).Position(4) = 0.05*ScreenHeight;
end

engine_slide.Position(4) = 0.6*ScreenHeight;
...
% DISPLAY ONLY UICONTROLS THAT ARE ON ENGINE SECTION